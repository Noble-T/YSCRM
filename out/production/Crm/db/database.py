    ...
    with open('../conf/config.yaml', 'r', encoding='utf-8') as file:
        ...
        for order_value in order_values:
            if order_value != '':
                ...
                # 系统用户表
                order_sql = "select o.* from `stock-rubik-cube`.`order` o where o.order_id = %s;"
