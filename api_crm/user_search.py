...
HEADERS = {
    ...
    'Accept': 'application/json, text/javascript,text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
        ...
        if response:
            ...
            if result and isinstance(result, dict): # 尝试判断结果是否为字典
                ...
                if any(keyword in result_str for keyword in keywords):
                    ...
                    # Python 获取字典中的信息，使用 get() 方法（推荐），如果键不存在返回 None，更加安全
